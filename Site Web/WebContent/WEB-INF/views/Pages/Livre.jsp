...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./Ressources/Css/blog.css">
    <link rel="stylesheet" type="text/css" href="./Ressources/Css/blog_responsive.css">
    ...
    <script src="./Ressources/Js/blog.js"></script>
    <script type="text/javascript" src="./Ressources/Js/jquery.mkinfinite.js"></script>
    <script src="./Ressources/Js/ScriptChercher.js"></script>
...
<body>
   <div class="container-fluid">
	  ...
	  <div class="content row">
	     <%@include file="../Contents/ContentLivreSite.jsp" %>
	  </div>
	  <div class="footer">
