...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./Ressources/Css/contact_responsive.css">
    ...
    <script src="./Ressources/bootstrap4/popper.js"></script>
    <script src="./Ressources/bootstrap4/bootstrap.min.js"></script>
    <script src="./Ressources/plugins/easing/easing.js"></script>
    <script src="./Ressources/plugins/parallax-js-master/parallax.min.js"></script>
...
<body>
   <div class="container-fluid">
	  ...
	  <div class="content">
	      <%@include file="../Contents/ContentContacter.jsp" %>
	  </div>
	  <div class="footer">
