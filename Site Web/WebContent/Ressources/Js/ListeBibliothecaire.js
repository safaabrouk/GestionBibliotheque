...
function Supprimer(){
	...
	swal({
        text: "vous voulez vraiment supprimer ce bibliothecaire!",
      ...
      .then((willDelete) => {
        if (willDelete) {
        	...
        	$.post("bibliothecaires",{"idProfil":idProfil,"idPersonne":idPersonne,"operation":"supprimer"},
    				function(data){
              if(data == 1){
            	  tr.remove();           	  
                  swal("Bibliothecaire bien supprimer!", {
                  icon: "success",
                });
...
function ModifierEtat(){
	...
	if(option.includes("valide")){
		...
		$.post("bibliothecaires",{"idProfil":idProfil,"operation":"valider"},
 				function(data){
              if(data==1){
		...
		$.post("bibliothecaires",{"idProfil":idProfil,"operation":"desactiver"},
			function(data){
			if(data == 1){
		...
		$.post("bibliothecaires",{"idProfil":idProfil,"operation":"activer"},
			function(data){
			if(data == 1){
