...
<head>
    ...
    <title> ReadMore | Mon profil </title>
     <!-- Vendor styles -->
     ...
     <link rel="stylesheet" href="./Ressources/vendors/bower_components/dropzone/dist/dropzone.css">
...
<body  data-sa-theme="5">
   <main class="main">
	   	...
	   	<header class="header">
	   	       ...
	   	       <%@include file="../Contents/ContentProfil.jsp"%>
