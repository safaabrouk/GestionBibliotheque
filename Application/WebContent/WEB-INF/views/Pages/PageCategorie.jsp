...
<head>
    ...
    <title> ReadMore | Categorie </title>
     <!-- Vendor styles -->
     ...
     <link rel="stylesheet" href="./Ressources/Css/Categorie.css">
...
<body  data-sa-theme="5">
   <main class="main">
	   	...
	   	<header class="header">
	   	       ...
	   	       <%@include file="../Contents/ContentCategorie.jsp"%>
...
<!-- Javascript -->
	    ...
	    <script src="./Ressources/Js/Categorie.js"></script>
