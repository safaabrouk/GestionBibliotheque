...
<%@page import="models.Personne"%>
 ...
 if(p != null && p.getRole().equals(Role.utilisateur)){
...
<head>
    ...
    <title> ReadMore | Livres </title>
     ...
     <link rel="stylesheet" href="./Ressources/vendors/bower_components/trumbowyg/dist/ui/trumbowyg.min.css">
...
<body  data-sa-theme="5">
   <main class="main">
	   	...
	   	<header class="header">
	   	       ...
	   	       <%@include file="../Contents/Contentlivre.jsp"%>
...
<!-- Javascript -->
        ...
        <script src="./Ressources/vendors/bower_components/Clamp.js/clamp.js"></script>
        <script src="./Ressources/vendors/bower_components/trumbowyg/dist/trumbowyg.min.js"></script>
        <!-- Charts and maps-->
    ...
    <script src="./Ressources/Js/LivreUtilisateur.js"></script>
