...
<head>
    ...
    <title> ReadMore | Liste Bibliothecaire </title>
     <!-- Vendor styles -->
     ...
     <link rel="stylesheet" href="./Ressources/Css/Livre.css">
...
<body  data-sa-theme="5">
   <main class="main">
	   	...
	   	<header class="header">
	   	       <%@include file="../Headers/HeaderFullScreen.jsp"%>
	   	</header>

	   	       <%@include file="../Contents/ContentListeBibliothecaire.jsp"%>
...
<!-- Javascript -->
	    ...
	    <script src="./Ressources/Js/ListeBibliothecaire.js"></script>
